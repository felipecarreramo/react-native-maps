...
class MapView extends React.Component {
  ...
  animateToView(latLng, altitudeMeters, bearing, angle, duration) {

    this._runCommand('animateToView', [latLng,
  	 altitudeMeters || 50,
  	 bearing || 0,
  	 angle || 0,
  	 duration || 500]);
  ...
  followCoordinate(latLng, bearing, angle, duration) {

    this._runCommand('followCoordinate', [latLng,
     bearing || 0,
     angle || 0,
     duration || 500]);
  }
